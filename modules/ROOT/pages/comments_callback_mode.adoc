...
* xref:#_tinycomments_create[`+tinycomments_create+`]
* xref:#_tinycomments_reply[`+tinycomments_reply+`]
* xref:#_tinycomments_edit_comment[`+tinycomments_edit_comment+`]
* xref:#_tinycomments_delete_comment[`+tinycomments_delete_comment+`]
* xref:#_tinycomments_delete[`+tinycomments_delete+`]
* xref:#_tinycomments_delete_all[`+tinycomments_delete_all+`]
* xref:#_tinycomments_lookup[`+tinycomments_lookup+`]

The xref:#_tinycomments_resolve[`+tinycomments_resolve+`] option is _optional_.
