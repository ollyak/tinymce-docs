...
____
*Note*: This plugin is only available for xref:{pricingpage}[{cloudname} users].
____
...
The storage and bandwidth quota varies based upon your xref:{pricingpage}[{cloudname} Plan].
