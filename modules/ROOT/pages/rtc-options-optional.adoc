...
* xref:#_rtc_server_disconnected[`+rtc_server_disconnected+`]
* xref:#_rtc_user_details_provider[`+rtc_user_details_provider+`]
...
* xref:#_rtc_snapshot[`+rtc_snapshot+`]
* xref:#_rtc_initial_content_provider[`+rtc_initial_content_provider+`]
* xref:#_rtc_client_info[`+rtc_client_info+`]
* xref:#_rtc_client_connected[`+rtc_client_connected+`]
* xref:#_rtc_client_disconnected[`+rtc_client_disconnected+`]
* xref:#_rtc_unsupported_content_notification[`+rtc_unsupported_content_notification+`]
