...
* For information on adding and configuring the comments plugin for TinyMCE, see: xref:#_getting_started_with_the_comments_plugin_selecting_a_mode[Getting started with the Comments plugin - Selecting a mode].
...
The following example shows how to configure the Comments plugin in *embedded* mode. For information on configuring the Comments plugin, see: xref:#_getting_started_with_the_comments_plugin_selecting_a_mode[Comments plugin Modes].
