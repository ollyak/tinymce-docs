...
* For information on adding and configuring the comments plugin for TinyMCE, see: <<_getting_started_with_the_comments_plugin_selecting_a_mode, Getting started with the Comments plugin - Selecting a mode>>.
