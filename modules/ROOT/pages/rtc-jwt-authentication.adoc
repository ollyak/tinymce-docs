...
* xref:#_setting_up_jwt_authentication_for_real_time_collaboration[Setting up JWT authentication for Real-Time Collaboration]
* xref:#_add_a_public_key_to_the_tiny_cloud_api_key[Add a public key to the {cloudname} API key]
* xref:#_set_up_a_json_web_token_jwt_endpoint[Set up a JSON Web Token (JWT) endpoint]
* xref:#_jwt_endpoint_examples[JWT endpoint examples]
