...
xref:#_a11ychecker_html_version[HTML version] : HTML4 and HTML5
...
xref:#_a11ychecker_html_version[HTML version] : HTML4
...
id : The issue identifier used by {productname}, such as D1, T4A. For a description and other details about the issue, see xref:#_accessibility_rules[Accessibility Rules].
