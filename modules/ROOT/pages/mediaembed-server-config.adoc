...
[[combining_iframely_and_custom_endpoints]]
...
A summary card is an embeddable snippet of code which is generated based on what the Enhanced Media Embed service can work out about the content at the URL. See the integration docs for xref:mediaembed-server-integration.adoc#summary_cards[Enhanced Media Embed Server] for further details.
