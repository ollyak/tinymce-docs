...
For information on other {cloudfilemanager} config options refer to the xref:tinydrive-dropbox-and-google-drive.adoc#configuring_with_google_drive[configuration] section of this document.
