...
For a list of supported algorithms, see: xref:rtc-jwt-authentication.adoc#generate_a_key_pair_locally[RTC JWT Authentication - Supported algorithms].
...
* The payload part does not contain all xref:rtc-jwt-authentication.adoc#required_jwt_claims_for_real_time_collaboration[required claims]
