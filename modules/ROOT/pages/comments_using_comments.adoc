...
* xref:#_add_a_comment[Add a comment].
* xref:#_edit_a_comment[Edit a comment].
* xref:#_delete_a_comment[Delete a comment].
* xref:#_delete_a_comment_thread_conversation[Delete a comment thread (conversation)].
* xref:#_resolve_a_comment_thread_conversation[Resolve a comment thread (conversation)].
* xref:#_show_or_view_a_comment[Show or view a comment].
* xref:#_delete_all_comment_threads[Delete all comment threads].
...
____
*NOTE*: This feature requires the xref:comments_callback_mode.adoc#_tinycomments_resolve[`+tinycomments_resolve+`] or xref:comments_embedded_mode.adoc#_tinycomments_can_resolve[`+tinycomments_can_resolve+`] setting to be configured.
____
