...
NOTE: `+pass:a[{proxy_setting_name}]+` is *not* required when enabling this plugin via xref:editor-and-features.adoc[{cloudname}].

Type: `+String+`

=== Example: Using `+pass:a[{proxy_setting_name}]+`
