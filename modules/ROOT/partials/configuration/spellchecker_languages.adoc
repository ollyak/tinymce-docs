...
This option specifies the spellchecker languages that are available to the user, provided as a comma delimited string. For a list of available languages, see: xref:introduction-to-tiny-spellchecker.adoc#spellchecker_languages[Supported languages].
