...
A registered format can also be used by name with the built-in xref:user-formatting-options.adoc#using_custom_formats[Using custom formats] for an example.
...
[[example_of_usage_of_the_formats_option]]
