...
This option accepts an object that must be serializable (`+JSON.stringify+` will be used to transmit it between clients). Other clients receive a copy of this object in their xref:#_rtc_client_connected[`+rtc_client_connected+`] events.
