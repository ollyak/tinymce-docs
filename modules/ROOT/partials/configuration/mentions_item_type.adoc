...
For information on the properties required for the user object provided to xref:mentions.adoc#mentions_fetch[`+mentions_fetch+`], see: xref:user_properties[User properties].
